...
class EN_model(pl.LightningModule):
    def __init__(self, model_type, model_cfg, training_cfg):
        ...
        #self.reverse_scheduled_sampling = self.model_cfg["reverse_scheduled_sampling"]
        self.r_sampling_step_1 = self.training_cfg["r_sampling_step_1"]
        self.r_sampling_step_2 = self.training_cfg["r_sampling_step_2"]
        self.r_exp_alpha = self.training_cfg["r_exp_alpha"]
        
        #self.scheduled_sampling = self.model_cfg["scheduled_sampling"]
        self.sampling_stop_epoch = self.training_cfg["sampling_stop_epoch"]
        self.sampling_start_value = self.training_cfg["sampling_start_value"]
        self.sampling_stop_epoch = self.training_cfg["sampling_stop_epoch"]
        self.sampling_changing_rate = self.training_cfg["sampling_changing_rate"]
